...
heatmap.2(correlation_matrix,
          col = colors,
          main = "Correlation heatmap of drug concentration and response",
          xlab = "Drug",
          ylab = "Cell",
          trace = "none",
          cexRow = 0.7,
...
fviz_nbclust(pca_data_prism.filtered1_drugs_variances_PC, kmeans, method = "wss") + geom_vline(xintercept = 2, linetype=2)
 #it works ith pc_scpres_prism in the same way, so both are correct
