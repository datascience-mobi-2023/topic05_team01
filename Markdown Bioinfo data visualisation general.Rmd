...
```{r}
prism_cleaned_drugs <- as.data.frame(sapply(prism_cleaned_drugs, as.numeric))
non_numeric_cols <- sapply(prism_cleaned_drugs, function(x) !is.numeric(x))
names(prism_cleaned_drugs)[which(non_numeric_cols)]
```
