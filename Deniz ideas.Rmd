...
```{r}
heatmap(prism_celllines_matrix_filtered1)
```
...
#Further anaysis
## Find the mutation characteristics of most of the targets
```{r}
...
mutation_counts <- table(prism.snv$Variant_Classification)
