...
gastric.oncology_treatments  <- subset(prism.treat, indication == "gastric adenocarcinoma")

View (gastric.oncology_treatments )
...
gastric.nononcology_treatments  <- subset(prism.treat, indication == "gastric adenocarcinoma")
