...
cell_line_values_filtered <- cell_line_values[cell_line_values <= -5]
...
```{r}
cell_line_to_investigate <- "ACH-000678"
...
# Filter the treatments based on the response
cell_line_values_filtered <- cell_line_values[cell_line_values <= -7]
...
barplot(cell_line_values_filtered, 
        ...
        ylab = "Response", 
        las = 2,   # makes the x-axis labels vertical
        cex.names = 0.3) # reduces the size of the x-axis labels
```
