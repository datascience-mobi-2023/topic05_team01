...
```{r}
prism_onc <- prism[, selected_treat_onc,drop = FALSE] 
prism_nonc <- prism[, selected_treat_nonc,drop = FALSE]
```
...
prism_gastrictreat <- prism[, selected_gastric_treat,drop = FALSE]
```
