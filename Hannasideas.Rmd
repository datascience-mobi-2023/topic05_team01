...
for (i in seq_along(k_values)) {
  ...
  # Perform k-means clustering
  kmeans_result <- kmeans(pc_scores[, c("PC1", "PC2")], centers = k)
  
  # Calculate silhouette coefficient
  silhouette_values[i] <- silhouette(kmeans_result$cluster, dist(pc_scores[, c("PC1", "PC2")]))$avg.width
...
plot(k_values, silhouette_values, type = "b", xlab = "Number of clusters", ylab = "Silhouette coefficient")

# Plot within-cluster sum of squares (WCSS)
plot(k_values, wcss_values, type = "b", xlab = "Number of clusters", ylab = "Within-Cluster Sum of Squares (WCSS)")
